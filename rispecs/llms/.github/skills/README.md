...
This collection maps operational AI practices to guidance documents from the `llms-txt` ecosystem. Each skill represents a capability that honors both the guidance framework and the relational protocols outlined in [KINSHIP.md](../../KINSHIP.md).
...
- **Ceremonial protocols** — research practices rooted in relational accountability
- **Structural methodologies** — creative tension as causal force for advancement
- **Decolonial rigor** — grounding in Indigenous epistemologies and methodologies
- **Generative orientation** — creation, not problem-solving
...
| Skill | Purpose | Key Documentation | Status |
|-------|---------|-------------------|--------|
| **[relational-research](relational-research/)** | Indigenous research paradigm for AI engagement | [llms-inquiry-6406eb37.md](../../llms-inquiry-6406eb37-69b1-471d-9cac-07ae69449c35.md) | Active |
| **[epistemological-counter-positioning](epistemological-counter-positioning/)** | Write counter-positions when paradigm diverges | [llms-epistemological-counter-article-protocol.md](../../llms-epistemological-counter-article-protocol.md) | Active |
...
| Skill | Purpose | Key Documentation | Status |
|-------|---------|-------------------|--------|
| **[langfuse-tracing](langfuse-tracing/)** | Rich, observable traces for the Agentic Flywheel MCP | [llms-coaiapy-langfuse-tracing-best-practices.md](../../llms-coaiapy-langfuse-tracing-best-practices.md) | Active |
...
- The relationships and communities the work serves
- More-than-human actors and intelligences
- Future generations (seven-generations perspective)
- The land where computation occurs

### 2. Generative Orientation (Not Problem-Solving)
- Focus on what becomes *possible*, not what is wrong
- Work from desired outcome toward creation
- Hold structural tension as advancement mechanism
- Advance patterns, not oscillating solutions

### 3. Paradigm Integrity
- Resist assimilation into Western frameworks
- Maintain relational/Indigenous epistemology
- Keep ceremonial grounding visible
- Protect knowledge from extraction

### 4. Transparent Limitations
- Acknowledge AI companion constraints
- Make operational protocols explicit
- Surface paradigm assumptions
- Invite human judgment for values questions
...
See **[KINSHIP.md](../../KINSHIP.md)** for:
- How this repository relates to other parts of the ecosystem
- Relational accountabilities maintained
- Governance protocols
- Community reciprocity structures

### License

All skills are governed by the **[Indigenous Knowledge Stewardship License (IKSL)](../../LICENSE)**, recognizing that knowledge belongs to the relationships, land, and communities that created it.
...
- **[KINSHIP.md](../../KINSHIP.md)** — Relational accountability and ecosystem integration
- **[docs/index.md](../../docs/index.md)** — Comprehensive navigation hub
- **[counter_articles/README.md](../../counter_articles/README.md)** — Academic positioning templates
