...
- Structural tension cannot form without accurate assessment of "what is"
- Hidden concepts and biases distort reality perception
- **The structure of anything determines its behavior** — change the structure, change the pattern
- Conceptual risk (imagined) vs. actual risk (present) must be distinguished
...
See: [Structural Tension](structural-tension.md) for the full charting methodology.
...
These phases parallel the five ceremonial stages described in [Ceremonial Technology](ceremonial-technology.md).
...
See: [llms-delayed-resolution-principle.md](../llms-delayed-resolution-principle.md)
...
- **Knowledge-to-wisdom transformation** parallels ceremonial knowledge-making
- **Structural tension as sacred space** — the tension between vision and reality is *mana*
- **Advancing patterns** honor the relational web rather than extracting from it

See: [Relational Science](relational-science.md) · [Indigenous Research Paradigm](indigenous-research-paradigm.md)
...
- [llms-non-creative-orientation-approach-to-convert.txt](../llms-non-creative-orientation-approach-to-convert.txt) — reframing reactive methods
